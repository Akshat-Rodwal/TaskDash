...
const MyTasks = () => {
    ...
    const fetchTasks = async () => {
        setIsLoading(true);
        try {
            // Fetching all tasks for the list view, potentially with pagination if needed
            // For now, fetching same as dashboard but maybe higher limit or all
                    ...
                    <div className="mb-8 flex flex-col justify-between gap-4 sm:flex-row sm:items-center">
                        <div>
                            ...
                            <p className="text-gray-500 mt-1">
                                Keep track of your team's progress and velocity.
                            </p>
                        </div>
                    ...
                    {isLoading ? (
                        ...
                        <div className="grid grid-cols-1 gap-4">
                            {filteredTasks.map((task) => (
                                <div
                                    key={task._id}
                                    className="group flex flex-col sm:flex-row justify-between p-6 bg-white rounded-xl shadow-sm border border-gray-100 hover:shadow-md transition-all duration-200"
                                >
                                    <div className="flex-1">
                                        <div className="flex items-center gap-3 mb-2">
                                            ...
                                            <div
                                                className={`flex items-center gap-1.5 px-2.5 py-0.5 rounded-full border text-xs font-medium ${getStatusColor(
                                                    task.status
                                                )}`}
                                            >
                                    ...
                                    <div className="flex items-center justify-between sm:justify-end gap-4 sm:gap-6 mt-4 sm:mt-0 min-w-[200px]">
                                ...
                                <div className="p-6 space-y-6">
                                    ...
                                    <div>
                                        ...
                                        <textarea
                                            ...
                                            rows={4}
                                            className="block w-full rounded-xl border border-gray-200 bg-gray-50 p-4 text-sm text-gray-900 focus:border-blue-500 focus:bg-white focus:outline-none focus:ring-2 focus:ring-blue-100 transition-all resize-none placeholder:text-gray-400"
